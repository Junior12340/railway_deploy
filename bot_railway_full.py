...
CATEGORY_GROUPS = {
    ...
    "Kommunal xizmatlar": int(os.getenv("GROUP_KOMMUNAL", os.getenv("GROUP_CHAT_ID", "-5278621112"))),
    "Ta'lim": int(os.getenv("GROUP_TALIM", os.getenv("GROUP_CHAT_ID", "-5101626932"))),
    "Sog'liqni saqlash": int(os.getenv("GROUP_SOGLIQ", os.getenv("GROUP_CHAT_ID", "-5221023540"))),
    "Ijtimoiy masalalar": int(os.getenv("GROUP_IJTIMOIY", os.getenv("GROUP_CHAT_ID", "-5027346625"))),
    "Boshqa": int(os.getenv("GROUP_BOSHQA", os.getenv("GROUP_CHAT_ID", "-5224658868")))
}
