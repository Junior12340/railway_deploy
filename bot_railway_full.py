    ...
    async def send_reminders(self):
        ...
        try:
            ...
            if old_requests:
                ...
                await self.bot.send_message(GROUP_CHAT_ID, message, parse_mode="HTML")
...
async def cmd_start(message: Message):
    ...
    welcome_text = (
        ...
        "📝 Men murojaatlar botiman. Men orqali siz:\n"
...
async def start_murojaat(message: Message, state: FSMContext):
    ...
    if daily_count >= DAILY_LIMIT:
        await message.answer(
            ...
            f"Maksimal ruxsat: {DAILY_LIMIT} ta murojaat/kun\n\n"
...
async def main():
    ...
    try:
        ...
        logger.info(f"👥 Guruh: {GROUP_CHAT_ID}")
